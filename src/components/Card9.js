...
const Card9 = () => {
  return (
    <a href="https://open.spotify.com/intl-es/album/5EzDhyNZuO7kuaABHwbBKX?si=WzSo21mOTMeU-yZMyLwU0g" target="_blank" className='bg-spotify-lightgray rounded-lg p-4 hover:bg-spotify-lightgrayHover transition-all group'>
        ...
        <div className='pl-2'>
            <h5 className='font-medium text-gray-100 mb-2'>Joji</h5>
            <p className='font-medium text-gray-400 text-sm w-[18ch]'>Nectar</p>
        </div>
     </a>
  )
}
