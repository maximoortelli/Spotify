...
const Cardg = () => {
  return (
    <a href="https://open.spotify.com/intl-es/album/2a2LGFK2TeN4fAKm1ZOc1I?si=xI-9z-UKSheMrRc-VB0ebg" target='_blank' className='bg-spotify-lightgray rounded-lg p-4 hover:bg-spotify-lightgrayHover transition-all group'>
        ...
        <div className='pl-2'>
            <h5 className='font-medium text-gray-100 mb-2'>Jhay Cortez</h5>
            <p className='font-medium text-gray-400 text-sm w-[18ch]'>Famouz</p>
        </div>
     </a>
  )
}
